...
* [Processador Monociclo](https://github.com/arduinoufv/inf250/blob/master/2024/monociclo.md)
   -----------------
   # Aulas
   ## 13/8 - Apresentação da metodologia para Trabalhos com IA e Demo FPGA
   ---
  ...
  * Gerador de exercícios [Assembly para Binário](https://colab.research.google.com/drive/1QHVEaphOLVFhRe-NSnaqh7N6nyrzNSPx?usp=sharing) e [Binário para Assembly](https://colab.research.google.com/drive/1_IJVgOGokCY0RMEBD1bR6CD1oAiDIJwE?usp=sharing)
  * [Resumo do significado das Instruções](https://www.ic.unicamp.br/~edson/disciplinas/mc404/2019-2s/ab/anexos/RISC_V_refcard.pdf)
  * [Resumo da codificação Risc-V](https://www.cs.sfu.ca/~ashriram/Courses/CS295/assets/notebooks/RISCV/RISCV_CARD.pdf)
  * [Gerador de exercícios para treinar](https://colab.research.google.com/drive/1KpKzXLy5DYOklvlpxxM0hHujUtBQmQ9M?usp=sharing)

#  Prova 1 - 24/09/26 - 30 pontos - sala PVA 153
* **Importante fazer os trabalhos** apesar do  **prazo máximo ser dia 28/9/26, após a prova** 
* Questões Prova: 1. Codificar Float7, 2. Codificar e Decodificar Risc-V, 3. Executar um trecho Código Risc-V, 4. Fazer alteração do formato Float em um código Assembly Risc-V para multiplicar ou somar, 5. Fazer três estilos de Maquina de estado para um Problema com Pisca ou Cores de Leds e Entradas.
* [Playlist video para Prova](https://www.youtube.com/playlist?list=PLIkFZCdvIVjY)
* Provas Anteriores [2025](https://docs.google.com/document/d/1RjPYTD0qx3_0RWkJpSqxn_2MyoWmtF8Sh7lZhBoLeMY/edit?usp=sharing) [2024](https://docs.google.com/document/d/1PeDUw-hX4ObsACK4ymP6w59NDXi-NYeqgw25u8gFTUI/edit?usp=sharing) [2023](https://docs.google.com/document/d/1PGxTOI4rpU9b8-USWu0SDjORjCig77qxNr6iyKraEBU/edit?usp=sharing)
  ----
  ----
